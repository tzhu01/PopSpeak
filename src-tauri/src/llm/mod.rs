...
pub struct PolishRequest {
    ...
    /// STT language code (e.g. "zh", "en", "multi"). Used to route between
    /// Chinese and English system prompts.
    pub stt_language: String,
    /// Recent polished sentences for context continuity (latest last, max 3).
